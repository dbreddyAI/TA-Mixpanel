# Derivative library separated to maintain consistency across dynamic builds & updates of Splunk Addon Builder
# modified verision of Splunk KVClient: cloudconnectlib > splunktalib > kv_client.py
#
# Modified by: Evan Davison
#
# Adds following functions: 
#   - create lookup config including fields
#   - delete collection records based on query
